const typesProducts = [
...

    {
        ...
        "img": ["https://www.yaphone.com/4584-large_default/samsung-galaxy-a32-5g.jpg"],
        "price": "ARS 61,600.00",
        "description": "Con la mejor cámara, rendimiento y conectividad en un smartphone Galaxy, el Galaxy S22 Ultra reinventa la experiencia móvil al fusionar las funciones favoritas de los fanáticos de las series Note y S.",
        "rating": 0,
        "stock": 25,
...

    {
        ...
        "img": ["https://bdt.computerhoy.com/sites/default/files/iphone-13-pro-max-blue-select.png"],
    ...
    {
        "name": "iPhone 13 mini",
        "img": ["https://jfccelulares.com.ar/wp-content/uploads/2021/10/iphone-13-mini-midnight-select-2021.png"],
...

    {
        ...
        "img": ["https://papayadeals.net/wp-content/uploads/2021/01/iphone-12-pro-max-blue-hero.png"],
    ...
    {
        "name": "iPhone 12 Pro",
        "img": ["https://itechstore.com.ar/wp-content/uploads/2020/06/iphone-12-pro-blue-hero.png"],
    ...
    {
        "name": "iPhone 12",
        "img": ["https://www.sharecomputacion.com/wp-content/uploads/2021/07/iphone12.png"],
    ...
    {
        "name": "iPhone 12 mini",
        "img": ["https://cbafederal.net/wp-content/uploads/2021/02/i-12-minii.png"],
    ...
    {
        "name": "iPhone 8 Plus",
        "img": ["https://tiendacell.uy/wp-content/uploads/2020/11/iPhone-8-Plus-Space-Grey-1.png"],
        "price": "ARS 80,000.00",
    ...
    {
        "name": "iPhone X",
        "img": ["https://i.ibb.co/VYQhGdv/51-V8-Ob-Wrp-KL.png"],
...

    {
        ...
        "img": ["https://motorolaes.vtexassets.com/arquivos/ids/157893/moto-edge-20-pdp-render-12-stout-zb2dm9z7.png?v=637630776676700000"],
        "price": "ARS 69,999.00",
...

    {
        ...
        "img": ["https://armoto.vtexassets.com/arquivos/ids/161923/2021_Rogue_Basic-Pack_0000_2021_Rogue_Basic-Pack_Cosmos_PDP-HERO.png?v=637841782155630000"],
        "price": "ARS 80,000.00",
...

    {
        ...
        "img": ["https://motorolaes.vtexassets.com/arquivos/ids/158056/Moto-G31-pdp-kv-renderzi1ofvgw.png?v=637726787786670000"],
        "price": "ARS 55,000.00",
...

    {
        ...
        "img": ["https://armoto.vtexassets.com/arquivos/ids/161725-800-auto?v=637810639346870000&width=800&height=auto&aspect=true"],
        "price": "ARS 69,999.00",
    ...
    {
        "name": "Moto G71 5G",
        "img": ["https://armoto.vtexassets.com/arquivos/ids/161713/2021_Corfu-5G_Verde-Jade_0000_2021_Corfu-5G_BasicPack_NeptuneGreen_PDPHero.png?v=637810634321000000"],
        "price": "ARS 75,999.00",
...

    {
        ...
        "img": ["https://motorolaes.vtexassets.com/arquivos/ids/158029/Moto-G200-pdp-render-Mirage-4-fvakpqsz.png?v=637726686351030000"],
        "price": "ARS 99,999.00",
    ...
    {
        "name": "Moto E7i Power",
        "img": ["https://motorolasv.vtexassets.com/arquivos/ids/155598/158915-800-800.png?v=637553205347830000"],
        "price": "ARS 40,000.00",
...

    {
        ...
        "img": ["https://armoto.vtexassets.com/arquivos/ids/161391/moto_e40_gris_2.png?v=637779821677400000"],
        "price": "ARS 29,999.00",
    ...
    {
        "name": "Moto E20",
        "img": ["https://www.motorola.com.gt/arquivos/Moto-e20-1000-1p2m6brnz.png"],
        "price": "ARS 25,000.00",
...

    {
        ...
        "img": ["https://wybo.es/wp-content/uploads/2021/04/pms_1614652745.53074465.png"],
        "price": "ARS 85,099.00",
    ...
    {
        "name": "Xiaomi 12X",
        "img": ["https://i01.appmifile.com/webfile/globalimg/pic/xiaomi-12x-black.png"],
    ...
    {
        "name": "Xiaomi 12 Pro",
        "img": ["https://i.blogs.es/1b7f1e/gris/original.png"],
        "price": "ARS 220,000.00",
    ...
    { 
        ...
        "img": ["https://i.ibb.co/7g2YkcC/3.png"],
        "price": "ARS 85,099.00",
...

    {
        ...
        "img": ["https://media.vozpopuli.com/2022/03/pms_1644824604.87483268-2.png"],
        "price": "ARS 62,700.00",
...

    {
        ...
        "img": ["https://i01.appmifile.com/webfile/globalimg/pic/Redmi-Note-11-Azul-Ocaso.png"],
        "price": "ARS 65,000.00",
    ...
    {
        "name": "Xiaomi redmi note 10 pro",
        "img": ["https://comunicaplus.net/wp-content/uploads/2021/06/note-10.png"],
        "price": "ARS 85,099.00",
...

    {
        ...
        "img": ["https://www.sharecomputacion.com/wp-content/uploads/2022/02/NOTE-11-AZUL.png"],
        "price": "ARS 47,000.00",
    ...
    {
        "name": "Xiaomi 12",
        "img": ["https://i01.appmifile.com/webfile/globalimg/pic/Xiaomi12_Black-front.png"],
        "price": "ARS 48,400.00",
    ...
    {
        "name": "lg k10",
        "img": ["https://static.wixstatic.com/media/dbdfeb_851813d782484c05b76bdea03c3f41c8~mv2.png/v1/fit/w_500,h_500,q_90/file.png"],
        "price": "ARS 8,200.00",
...

    {
        ...
        "img": ["https://storage.comprasmartphone.com/smartphones/lg-velvet-5g.png"],
    ...
    {
        "name": "LG G8s",
        "img": ["https://i.ibb.co/QXkwx2t/4-copia.png"],
        "price": "ARS 24,999.00",
        "description": "Diseñado para impresionar. El vidrio 2.5D brinda un acabado más sofisticado y colorido a la parte posterior, y el metal lateral crea una sensación de equilibrio y distinción. Los detalles redondeados y refinados proporcionan el agarre ergonómico óptimo.",
        "rating": 0,
        "stock": 70,
    ...
    {
        "name": "LG Q7+",
        "img": ["https://lgservice.es/wp-content/uploads/2021/02/LG-Q7-plus.png"],
        "price": "ARS 35,000.00",
    ...
    {
        "name": "LG Q60",
        "img": ["https://i.ibb.co/ZfXmzXY/5.png"],
        "price": "ARS 40,000.00",
    ...
    {
        "name": "LG K62",
        "img": ["https://pics.chimeratool.com/modelimages/12474_1611825956_34196fe68c2cda19e4b3f2a1b4261475c3c2763b.png"],
        "price": "ARS 47,500.00",
    ...
    { // PNG
        "name": "LG K52",
        "img": ["https://www.chedraui.com.mx/medias/7502294047516-00-CH515Wx515H?context=bWFzdGVyfHJvb3R8MzI3MDd8aW1hZ2UvanBlZ3xoNWQvaDhmLzExNjg0MDY0ODU0MDQ2LmpwZ3wxNWFhODBjZWI5YTRjMmExNTcwMzZkNWUwZTUwNDU2M2RkNTBlNGUxYTgzOGI2MDRhYThkNGY3MTFkZWFjNmQ1"],
        "price": "ARS 36,200.00",
    ...
    {
        "name": "LG K61",
        "img": ["https://i.ibb.co/WcN1yNj/6.png"],
        "price": "ARS 51,850.00",
    ...
    {
        "name": "LG K71",
        "img": ["https://i.ibb.co/YPYBQXf/7.png"],
        "price": "ARS 62,200.00",
    ...
    {
        "name": "huawei p50 pro",
        "img": ["https://img01.huaweifile.com/sg/ms/co/pms/uomcdn/CO_HW_B2C/pms/202201/gbom/6941487243280/800_800_79F8C1BCE190C2854F95257328F0151Bmp.webp"],
...

    {
        ...
        "img": ["https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/admin-image/phones/nova9-se/list/list-white.png"],
        "price": "ARS 72.000.00",
    ...
    {
        "name": "Huawei nova 8i",
        "img": ["https://cdn.andro4all.com/andro4all/2021/07/Huawei-Nova-8i-negro.png"],
        "price": "ARS 52.000.00",
    ...
    {
        "name": "Huawei nova 9",
        "img": ["https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/admin-image/phones/nova9-se/list/list-blue.png"],
        "price": "ARS 75.000.00",
    ...
    {
        "name": "Huawei P50",
        "img": ["https://img01.huaweifile.com/sg/ms/pe/pms/uomcdn/PE_HW_B2C/pms/202204/gbom/6941487243280/428_428_FF1734705AB5D54AD33B2D1BEABB84BCmp.png"],
    ...
    {
        "name": "Huawei Mate X2",
        "img": ["https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/phones/mate-x2/list/img-blue-v1.png"],
...

    {
        ...
        "img": ["https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/phones/porsche-design-mate40-rs/list-img/white.png"],
    ...
    {
        "name": "Huawei Mate 40",
        "img": ["https://img01.huaweifile.com/sg/ms/ph/pms/product/6941487202423/428_428_915BA4370EB01FBC09777F158E7098013772995D1E37DD85mp.png"],
    ...
    {
        "name": "Huawei Y8p",
        "img": ["https://srmtechstore.com/wp-content/uploads/2021/05/H03.png"],
        "price": "ARS 49.000.00",
